...
[shs.position, shs.step_and_orient] = plotTrajectory(target,shs,shs_sample.door_handle_use);
...
[~, ~] = plotTrajectory(target,shs,shs_sample.door_handle_use);
